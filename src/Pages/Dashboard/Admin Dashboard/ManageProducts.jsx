...
const ManageProducts = () => {
    ...
    // Function to fetch the list of products from your backend API
    const fetchProducts = async () => {
        try {
            const response = await fetch('https://ecommerce-pollux-server.vercel.app/products');
            if (response.ok) {
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://ecommerce-pollux-server.vercel.app/products/${_id}`, {
                method: 'PUT',
                headers: {
    ...
    const handleDeleteProduct = async (productId) => {
        ...
        try {
            const response = await fetch(`https://ecommerce-pollux-server.vercel.app/products/${productId._id}`, {
                method: 'DELETE',
            });
